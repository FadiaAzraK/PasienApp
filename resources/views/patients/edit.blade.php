...
<div class="form-card">
    ...
    <form action="{{ route('patients.update', $patient) }}" method="POST">
        ...
        <div class="mb-3">
            <label>NIK</label>
            <input name="nik" value="{{ old('nik', $patient->nik) }}" class="form-control">
        ...
        <div class="mb-3">
            ...
            <div class="gender-options">
                <label>
                    <input type="radio" name="gender" value="L" {{ old('gender', $patient->gender)=='L'?'checked':'' }}>
                    Laki-laki
                </label>
                <label>
                    <input type="radio" name="gender" value="P" {{ old('gender', $patient->gender)=='P'?'checked':'' }}>
                    Perempuan
                </label>
            </div>
